namespace GameCreator.Core
{
	...
	public class Hotspot : MonoBehaviour 
	{
		...
		private void Awake()
		{
			...
			this.cursorData = HPCursor.Create<HPCursor>(this, this.cursorData) as HPCursor.Data;
			this.proximityData = HPProximity.Create<HPProximity>(this, this.proximityData) as HPProximity.Data;
			this.headTrackData = HPHeadTrack.Create<HPHeadTrack>(this, this.headTrackData) as HPHeadTrack.Data;
		}
