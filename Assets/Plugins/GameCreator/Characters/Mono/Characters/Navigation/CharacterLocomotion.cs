namespace GameCreator.Characters
{
    ...
    public class CharacterLocomotion
    {
        ...
        public ObstacleAvoidanceType avoidanceType = ObstacleAvoidanceType.GoodQualityObstacleAvoidance;
        ...
        public void Update()
        {
            ...
            switch (this.currentLocomotionType)
            {
                ...
                case LOCOMOTION_SYSTEM.NavigationMeshAgent:
                    ...
                    this.navmeshAgent.obstacleAvoidanceType = this.avoidanceType;
                    break;
            }
