namespace GameCreator.Characters
{
    ...
    public class CharacterAnimation
    {
        ...
        private void SetupSectionDefaultStates()
        {
            ...
            this.mixerStatesInput = AnimationMixerPlayable.Create(this.graph, 1);
        ...
        private void SetupSectionStates()
        {
            ...
            this.mixerStatesOutput = AnimationMixerPlayable.Create(this.graph, 1);
        ...
        private void SetupSectionGestures()
        {
            ...
            this.mixerGesturesInput = AnimationMixerPlayable.Create(this.graph, 1);
            this.mixerGesturesInput.ConnectInput(0, this.mixerStatesOutput, 0, 1f);
            this.mixerGesturesInput.SetInputWeight(0, 1f);

            this.mixerGesturesOutput = AnimationMixerPlayable.Create(this.graph, 1);
