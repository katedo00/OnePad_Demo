namespace GameCreator.Characters
{
    ...
    public class CharacterAnimator : MonoBehaviour
    {
        ...
        public void PlayGesture(AnimationClip clip, float speed, AvatarMask avatarMask = null,
            float transitionIn = 0.15f, float transitionOut = 0.15f, bool skipIfRagdoll = true)
        {
            if (skipIfRagdoll && this.character.IsRagdoll()) return;
        ...
        public void StopGesture(float transitionOut = 0.0f, bool skipIfRagdoll = true)
        {
            if (skipIfRagdoll && this.character.IsRagdoll()) return;
