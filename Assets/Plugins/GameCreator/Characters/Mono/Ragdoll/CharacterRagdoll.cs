namespace GameCreator.Characters
{
    ...
    public class CharacterRagdoll
    {
        ...
        private void ToRecover()
        {
            ...
            {
                case true:
                    this.charAnimator.CrossFadeGesture(this.charAnimator.standFaceDown, 1f, null, 0f, 0.25f, false);
                    ragdollDirection = this.GetRagdollDirection();
                    break;

                case false:
                    this.charAnimator.CrossFadeGesture(this.charAnimator.standFaceUp, 1f, null, 0f, 0.25f, false);
        ...
        private bool BuildBonesData()
        {
            ...
            this.SetupJoint(Bone.Head, Bone.Spine, unitX, unitZ, -20, 10,  0, typeof(SphereCollider), 1f, 0.1f);
